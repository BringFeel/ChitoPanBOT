...
module.exports = {
    ...
    execute(msg, args) {
        ...
        .setColor('#26FF82')
        embed.setFooter('Owner: Bring Feel#2098 • Gracias por usar ChitoPanBOT', 'https://cdn.discordapp.com/attachments/795478872597594164/833157862825787412/91ed566974e33b4bd8d7506861b3d5de.jpg');
        embed.setTimestamp();
